...
pytest nodeid via the `admiral._reporting.current_test_nodeid` contextvar.
...
from admiral.redaction import REDACTION_VERSION
...
class TestRecord:
    ...
    admiral_meta: dict[str, Any] = field(default_factory=dict)
...
class Collector:
    ...
    def note_test_metadata(
        ...
        *,
        ...
        class_name: str | None,
        markers: list[str],
        admiral_meta: dict[str, object] | None = None,
        worker_id: str | None,
    ) -> None:
    ...
    def record_scenario(
        ...
        rec.scenarios.append(ScenarioRecord(result=result, completed_normally=completed_normally))
    ...
    def to_dict(
        ...
        *,
        ...
        for nodeid, rec in list(self.tests.items())[:TESTS_CAP]:
            ...
            scenario_outcomes_per_test[nodeid] = [s["outcome"] for s in scenarios]
            tests_json.append(
                {
                    "nodeid": nodeid,
                    "file": rec.file,
                    ...
                    "markers": rec.markers,
                    "admiral_meta": rec.admiral_meta or None,
