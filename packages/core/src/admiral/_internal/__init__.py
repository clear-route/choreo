...
Nothing in `admiral.*` outside this package should import from modules other than
this package's `__init__`.

`Dispatcher` and `LoopPoster` are **reserved scaffolding**
for a future threaded transport. No shipping transport uses
