"""Unit checks for migration `005_prd013_timeline_events`.
...
`tests/e2e/test_prd013_timeline_db.py` (Phase 3 PR 3.3) — that's
...
def test_alembic_should_treat_005_as_a_descendant_of_004():
    ...
    module = _load_migration_module("005_prd013_timeline_events")
...
def test_migration_005_upgrade_should_create_three_indexes():
    """PRD-013 §5 names three required indexes on `timeline_events`:
...
def test_the_migration_chain_should_be_linear():
    ...
    chain_pairs = [
        ...
        ("003_prd012_stage_transports", "002"),
        ("004_prd012_relax_handle_transport", "003"),
        ("005_prd013_timeline_events", "004"),
    ]
