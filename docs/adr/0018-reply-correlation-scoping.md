...
- Observability is automatic: the reply report ([ADR-0017](0017-reply-fire-and-forget-results.md)) distinguishes "never saw a candidate" from "saw candidates, matcher mismatched", so the echo failure is diagnosable.
